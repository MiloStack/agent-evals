import type { Check, CheckResult, EvalInput } from "../types.js";
...
export const hasTests: Check = {
  ...
  async run(input: EvalInput): Promise<CheckResult> {
    ...
    if (!src.length) return { check:"has-tests", passed:true, score:100, details:"No source files.", findings:[] };
